...
type PodResizeResources struct {
	RequestVersion string `json:"requestVersion,omitempty" protobuf:"bytes,1,opt,name=requestVersion"`
	Request        []ContainerResources `json:"request,omitempty" protobuf:"bytes,2,rep,name=request,casttype=ContainerResources"`
	ActionVersion  string `json:"actionVersion,omitempty" protobuf:"bytes,3,opt,name=actionVersion"`
	Action         PodResizeResourcesAction `json:"action,omitempty" protobuf:"bytes,4,opt,name=action,casttype=PodResizeResourcesAction"`
	Rollback       []ContainerResources `json:"rollback,omitempty" protobuf:"bytes,5,opt,name=rollback,casttype=ContainerResources"`
}
