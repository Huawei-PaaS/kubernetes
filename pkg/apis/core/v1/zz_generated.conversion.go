...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		...
		Convert_v1_ContainerResources_To_core_ContainerResources,
		Convert_core_ContainerResources_To_v1_ContainerResources,
		...
		Convert_v1_PodContext_To_core_PodContext,
		Convert_core_PodContext_To_v1_PodContext,
		...
		Convert_v1_PodResizeResources_To_core_PodResizeResources,
		Convert_core_PodResizeResources_To_v1_PodResizeResources,
...
func autoConvert_v1_ContainerResources_To_core_ContainerResources(in *v1.ContainerResources, out *core.ContainerResources, s conversion.Scope) error {
	out.Name = in.Name
	if err := Convert_v1_ResourceRequirements_To_core_ResourceRequirements(&in.Resources, &out.Resources, s); err != nil {
		return err
	}
...
// Convert_v1_ContainerResources_To_core_ContainerResources is an autogenerated conversion function.
func Convert_v1_ContainerResources_To_core_ContainerResources(in *v1.ContainerResources, out *core.ContainerResources, s conversion.Scope) error {
	return autoConvert_v1_ContainerResources_To_core_ContainerResources(in, out, s)
}

func autoConvert_core_ContainerResources_To_v1_ContainerResources(in *core.ContainerResources, out *v1.ContainerResources, s conversion.Scope) error {
	out.Name = in.Name
	if err := Convert_core_ResourceRequirements_To_v1_ResourceRequirements(&in.Resources, &out.Resources, s); err != nil {
		return err
	}
...
// Convert_core_ContainerResources_To_v1_ContainerResources is an autogenerated conversion function.
func Convert_core_ContainerResources_To_v1_ContainerResources(in *core.ContainerResources, out *v1.ContainerResources, s conversion.Scope) error {
	return autoConvert_core_ContainerResources_To_v1_ContainerResources(in, out, s)
}
...
func autoConvert_v1_Pod_To_core_Pod(in *v1.Pod, out *core.Pod, s conversion.Scope) error {
	...
	if err := Convert_v1_PodContext_To_core_PodContext(&in.Context, &out.Context, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_core_Pod_To_v1_Pod(in *core.Pod, out *v1.Pod, s conversion.Scope) error {
	...
	if err := Convert_core_PodContext_To_v1_PodContext(&in.Context, &out.Context, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_v1_PodContext_To_core_PodContext(in *v1.PodContext, out *core.PodContext, s conversion.Scope) error {
	out.ResizeResources = (*core.PodResizeResources)(unsafe.Pointer(in.ResizeResources))
	return nil
}

// Convert_v1_PodContext_To_core_PodContext is an autogenerated conversion function.
func Convert_v1_PodContext_To_core_PodContext(in *v1.PodContext, out *core.PodContext, s conversion.Scope) error {
	return autoConvert_v1_PodContext_To_core_PodContext(in, out, s)
}

func autoConvert_core_PodContext_To_v1_PodContext(in *core.PodContext, out *v1.PodContext, s conversion.Scope) error {
	out.ResizeResources = (*v1.PodResizeResources)(unsafe.Pointer(in.ResizeResources))
	return nil
}

// Convert_core_PodContext_To_v1_PodContext is an autogenerated conversion function.
func Convert_core_PodContext_To_v1_PodContext(in *core.PodContext, out *v1.PodContext, s conversion.Scope) error {
	return autoConvert_core_PodContext_To_v1_PodContext(in, out, s)
}
...
func autoConvert_v1_PodResizeResources_To_core_PodResizeResources(in *v1.PodResizeResources, out *core.PodResizeResources, s conversion.Scope) error {
	out.RequestVersion = in.RequestVersion
	out.Request = *(*[]core.ContainerResources)(unsafe.Pointer(&in.Request))
	out.ActionVersion = in.ActionVersion
	out.Action = core.PodResizeResourcesAction(in.Action)
	out.Rollback = *(*[]core.ContainerResources)(unsafe.Pointer(&in.Rollback))
	return nil
}

// Convert_v1_PodResizeResources_To_core_PodResizeResources is an autogenerated conversion function.
func Convert_v1_PodResizeResources_To_core_PodResizeResources(in *v1.PodResizeResources, out *core.PodResizeResources, s conversion.Scope) error {
	return autoConvert_v1_PodResizeResources_To_core_PodResizeResources(in, out, s)
}

func autoConvert_core_PodResizeResources_To_v1_PodResizeResources(in *core.PodResizeResources, out *v1.PodResizeResources, s conversion.Scope) error {
	out.RequestVersion = in.RequestVersion
	out.Request = *(*[]v1.ContainerResources)(unsafe.Pointer(&in.Request))
	out.ActionVersion = in.ActionVersion
	out.Action = v1.PodResizeResourcesAction(in.Action)
	out.Rollback = *(*[]v1.ContainerResources)(unsafe.Pointer(&in.Rollback))
	return nil
}

// Convert_core_PodResizeResources_To_v1_PodResizeResources is an autogenerated conversion function.
func Convert_core_PodResizeResources_To_v1_PodResizeResources(in *core.PodResizeResources, out *v1.PodResizeResources, s conversion.Scope) error {
	return autoConvert_core_PodResizeResources_To_v1_PodResizeResources(in, out, s)
}
...
func autoConvert_v1_PodSpec_To_core_PodSpec(in *v1.PodSpec, out *core.PodSpec, s conversion.Scope) error {
	...
	out.ResizeResourcesPolicy = core.PodResizeResourcesPolicy(in.ResizeResourcesPolicy)
	return nil
}
...
func autoConvert_core_PodSpec_To_v1_PodSpec(in *core.PodSpec, out *v1.PodSpec, s conversion.Scope) error {
	...
	out.ResizeResourcesPolicy = v1.PodResizeResourcesPolicy(in.ResizeResourcesPolicy)
	return nil
}
