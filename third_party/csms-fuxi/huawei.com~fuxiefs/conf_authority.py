...
def get_log_path():
    log_path = "/usr/libexec/kubernetes/kubelet-plugins/volume/exec/huawei.com~fuxiefs/etc/fuxi.conf"
...
def authority_config(install_path):
    try:
        ...
        os.chmod('/etc/logrotate.d/fuxi-efs.logrotate.conf', stat.S_IRUSR | stat.S_IWUSR | stat.S_IRGRP)
